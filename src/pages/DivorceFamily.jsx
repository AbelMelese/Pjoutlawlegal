                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="animate-enter">
                            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 font-['Playfair_Display'] mb-8">
                                Why Choose <span className="text-[#1E3A5F]">Our Firm?</span>
                            </h2>
                        ...
                        <div className="relative animate-float-delayed">
                            <div className="absolute -inset-4 bg-[#1E3A5F]/10 rounded-[2.5rem] blur-2xl"></div>
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {service.items.map((item, i) => (
                                                <span
                                                    key={i}
                                                    className="px-4 py-1.5 bg-slate-100 text-slate-600 rounded-full text-sm font-semibold group-hover:bg-[#1E3A5F]/10 group-hover:text-[#1E3A5F]700 transition-colors"
                                                >
                                                    {item}
                                                </span>
                                            ))}
                    ...
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        <div>
                            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 font-['Playfair_Display'] mb-8">
                                ...
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1E3A5F] to-[#5B2C6F]">Your Goals</span>
                            </h2>
                            <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                            ...
                            <div className="grid sm:grid-cols-2 gap-6">
                                {[
                                    ...
                                    <div key={index} className="flex items-center gap-3 p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
                                        <CheckCircle size={20} className="text-[#1E3A5F]" />
