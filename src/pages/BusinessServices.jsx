        ...
        <div className="overflow-hidden bg-[#f8fafc]">
            ...
            <section className="relative py-20 md:py-32 bg-[#0f172a] overflow-hidden">
                <div className="absolute inset-0 bg-slate-900">
                    ...
                    <div className="blob bg-blue-500/20 w-[800px] h-[800px] top-[-200px] right-[-200px] rounded-full blur-3xl"></div>
                </div>

                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center animate-enter">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 rounded-full mb-8 border border-white/10 backdrop-blur-sm">
                        <Building2 size={18} className="text-blue-400" />
                        <span className="text-blue-100 font-medium text-sm tracking-wide uppercase">Business Solutions</span>
                    </div>
                    ...
                    <p className="text-xl text-slate-400 max-w-3xl mx-auto mb-12">
                        From strategic advising to nonprofit compliance, we help businesses and
                        organizations navigate growth with clarity and confidence.
                    </p>

                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a
                            href="#advising"
                            className="btn-glow inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-slate-900 rounded-full font-bold text-lg hover:bg-slate-100"
                        >
                            <Briefcase size={20} />
                        ...
                        <a
                            href="#nonprofit"
                            className="inline-flex items-center justify-center gap-2 px-8 py-4 border border-white/20 text-white rounded-full font-bold text-lg hover:bg-white/10 transition-all"
                        >
                            <Heart size={20} />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-20 items-center mb-20 animate-enter">
                        ...
                        <div className="relative">
                            <div className="absolute -inset-4 bg-gradient-to-tr from-slate-200 to-slate-100 rounded-[2.5rem] -rotate-2"></div>
                            <div className="relative bg-slate-900 rounded-[2rem] p-12 overflow-hidden shadow-2xl">
            ...
            <section id="nonprofit" className="py-20 md:py-32 bg-slate-900 relative overflow-hidden">
                <div className="absolute inset-0">
                    <div className="blob bg-emerald-500/10 w-[600px] h-[600px] bottom-0 left-0 rounded-full blur-3xl"></div>
                </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        <div className="lg:order-2">
                            <div className="inline-flex items-center gap-3 px-4 py-2 bg-emerald-500/10 rounded-full mb-6 border border-emerald-500/20">
                                ...
                                <span className="font-semibold text-emerald-100 text-sm">Mission-Driven Support</span>
                            </div>
                            ...
                            <Link
                                to="/contact"
                                className="btn-glow inline-flex items-center gap-2 px-8 py-4 bg-emerald-600 text-white rounded-full font-bold hover:bg-emerald-500"
                            >
                        ...
                        <div className="lg:order-1 relative">
                            ...
                            <div className="relative bg-slate-800 rounded-[2rem] p-10 border border-white/10 shadow-2xl flex flex-col justify-center h-full">
                                ...
                                <div className="mt-8 pt-8 border-t border-white/10">
                                    <p className="text-xs font-bold text-emerald-400 uppercase tracking-widest mb-2">Case Highlight</p>
                                    <p className="text-slate-300 italic">"{nonprofitAdvisory.highlight}"</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-20">
                        <h2 className="text-4xl md:text-5xl font-bold text-slate-900 font-['Playfair_Display'] mb-6">
                            Practice Areas & <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-800">Case Highlights</span>
                        </h2>
                            ...
                            <div key={index} className={`flex flex-col gap-12 items-center ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'}`}>
                                <div className="flex-1 space-y-6">
                                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 rounded-full border border-blue-100">
                                        <area.icon size={18} className="text-blue-600" />
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mt-24">
                        {additionalPractices.map((practice, index) => (
                            <div key={index} className="bg-slate-50 rounded-2xl p-8 border border-slate-100 hover:shadow-lg transition-shadow">
                                <practice.icon size={32} className="text-blue-600 mb-6" />
